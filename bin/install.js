#!/usr/bin/env node
/**
 * @yottameta/yotta-secret cross-platform installer.
 *
 * Usage:
 *   npx -y @yottameta/yotta-secret --agent <name>
 *   npx -y @yottameta/yotta-secret --dir <path>
 *   npx -y @yottameta/yotta-secret -g
 *   npx -y @yottameta/yotta-secret
 *   npx -y @yottameta/yotta-secret --list
 */
'use strict';
...
function usage() {
  console.log('yotta-secret installer');
  console.log('');
  console.log('Usage:');
  console.log('  npx -y @yottameta/yotta-secret --agent <name>  Install to an agent default directory');
  console.log('  npx -y @yottameta/yotta-secret --dir <path>     Install to a custom directory');
  console.log('  npx -y @yottameta/yotta-secret -g               Install to all known agent directories');
  console.log('  npx -y @yottameta/yotta-secret                  Auto-detect project-level directories');
  console.log('  npx -y @yottameta/yotta-secret --list           List supported agent directories');
  console.log('');
  console.log('Options:');
